package com.example.dmitrypavlenko.traveler.Adapter;
...
import com.example.dmitrypavlenko.traveler.Helpers.CircleTransform;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    private List<ObservablePoint> messages;
    ...
    public MessagesAdapter(Context mContext, List<ObservablePoint> messages, MessageAdapterListener listener) {
